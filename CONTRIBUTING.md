...
- Keep docs in sync: `README.md`, `ARCHITECTURE.md`, `SECURITY.md`,
  `THIRD_PARTY.md`, `DECISIONS.md`.
...
- [ ] `DECISIONS.md` updated (new ADR entry if schema, transport, or deps changed)
- [ ] `THIRD_PARTY.md` updated if dependencies added / removed
- [ ] `README.md`, `ARCHITECTURE.md` reflect any new commands or workflows
