...
| @heroui/react | 3.2.6 | Apache-2.0 | UI component library | None |
| @heroui/styles | 3.2.5 | Apache-2.0 | HeroUI pre-built component styles | None |
| @tailwindcss/vite | 4.3.3 | MIT | Tailwind Vite integration plugin | None |
| lucide-react | 1.45.0 | MIT | SVG icon library for agent graph node icons | None |
| oxlint | 1.82.0 | MIT | JavaScript / TypeScript linter | None |
| TypeScript | 7.0.2 | Apache-2.0 | Static type checker | None |
| @types/node | 26.5.1 | MIT | Node.js type definitions for TypeScript | None |
...
| vitest | 5.0.0 | MIT | Frontend test runner | None |
