...
| `VITE_AGENT_SOLID_MINUTES` | `10` | Minutes an active agent stays 100% solid before fading |
| `VITE_AGENT_FADE_MINUTES` | `60` | Linear fade-out duration before agent is auto-removed from orbit canvas |
