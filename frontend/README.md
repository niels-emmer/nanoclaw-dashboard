...
- `src/components/ActivityFeed.tsx`, `ActivityDetail.tsx`, `AgentRoster.tsx`, `AgentDetail.tsx`, `StatusStrip.tsx`, `InstanceDetails.tsx`, `ErrorBoundary.tsx` – supporting panels + diagnostics (the full-screen instance details overlay opens from the status-bar liveness indicator).
