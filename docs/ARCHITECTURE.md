...
| Details panes | `ActivityFeed.tsx`, `AgentRoster.tsx`, `AgentDetail.tsx`, `StatusStrip.tsx` | Simplified conversation stream, compact auto-hiding agent roster, click-to-expand agent drill-down, and a top status bar with error/stuck/pending alerts. |
